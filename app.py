...
if id_number in menu:
    ...
    st.markdown(f"<div style='font-size:24px;margin-bottom:10px;padding:20px;background-color:#cee9ff'>Top 3 recommendations for {menu.get(id_number, 'Unknown Item')} are:</div>", unsafe_allow_html=True)
